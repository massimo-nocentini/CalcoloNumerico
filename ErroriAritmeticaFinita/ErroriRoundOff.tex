...
% ************************************************************************
% la seguente prova non \`e molto corretta in quanto per assurdo si suppone
% che n non esista, mentre si cerca una configurazione per andare poi a
% valutarla trovando proprio un n', supposto invece che non esista.
% ************************************************************************
...
% Per le ipotesi di assurdo, allora posso trovare almeno una rappresentazione
% $x':f(x') > f(x)$. Quindi la rappresentazione di $x'$ dovr\`a essere della forma $x' = \delta_{0}' \delta_{0} 
% \ldots \delta_{m + s}$,
